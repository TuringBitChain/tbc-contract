...
declare module 'tbc-contract' {
    ...
    export class poolNFT {
        ...
        initPoolNFT(privateKey_from: PrivateKey, address_to: string, utxo: Transaction.IUnspentOutput, ftPreTX: Transaction, ftPrePreTxData: string, tbc_amount?: number, ft_a?: number): Promise<string>;
        increaseLP(privateKey_from: PrivateKey, address_to: string, utxo: Transaction.IUnspentOutput, ftPreTX: Transaction, ftPrePreTxData: string, amount_tbc: number): Promise<string>;
        consumeLP(privateKey_from: PrivateKey, address_to: string, utxo: Transaction.IUnspentOutput, ftPreTX: Transaction[], ftPrePreTxData: string[], contractTX: Transaction[], amount_lp: number): Promise<string>;
        swaptoToken(privateKey_from: PrivateKey, address_to: string, utxo: Transaction.IUnspentOutput, ftPreTX: Transaction, ftPrePreTxData: string, contractTX: Transaction, amount_token: number): Promise<string>;
        swaptoToken_baseTBC(privateKey_from: PrivateKey, address_to: string, utxo: Transaction.IUnspentOutput, ftPreTX: Transaction, ftPrePreTxData: string, contractTX: Transaction, amount_tbc: number): Promise<string>;
        swaptoTBC(privateKey_from: PrivateKey, address_to: string, utxo: Transaction.IUnspentOutput, ftPreTX: Transaction[], ftPrePreTxData: string[], contractTX: Transaction, amount_tbc: number): Promise<string>;
        swaptoTBC_baseToken(privateKey_from: PrivateKey, address_to: string, utxo: Transaction.IUnspentOutput, ftPreTX: Transaction[], ftPrePreTxData: string[], contractTX: Transaction, amount_token: number): Promise<string>;
        ...
        mergeFTLP(privateKey_from: PrivateKey, utxo: Transaction.IUnspentOutput, ftPreTX: Transaction[], ftPrePreTxData: string[]): Promise<boolean | string>;
        mergeFTinPool(privateKey_from: PrivateKey, utxo: Transaction.IUnspentOutput, ftPreTX: Transaction[], ftPrePreTxData: string[]): Promise<boolean | string>;
