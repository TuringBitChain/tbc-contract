...
var API = /** @class */ (function () {
    ...
    API.getBaseURL = function (network) {
        var url_testnet = "https://tbcdev.org/v1/tbc/main/";
    ...
    API.fetchFtUTXO = function (contractTxid, addressOrHash, amount, codeScript, network) {
        return __awaiter(this, void 0, void 0, function () {
            var base_url, hash, publicKeyHash, url, response, responseData, data_1, fttxo_1, data, i, totalBalance, fttxo, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        base_url = "";
                    ...
                    case 3:
                        ...
                        if (amount === BigInt(0)) {
                            responseData.ftUtxoList.sort(function (a, b) {
                                return Number(b.utxoBalance - a.utxoBalance);
                            });
                            data_1 = responseData.ftUtxoList[0];
                            fttxo_1 = {
                                txId: data_1.utxoId,
                                outputIndex: data_1.utxoVout,
                                script: codeScript,
                                satoshis: data_1.utxoBalance,
                                ftBalance: data_1.ftBalance,
                            };
                            return [2 /*return*/, fttxo_1];
                        }
    ...
    API.fetchFtUTXOs = function (contractTxid, addressOrHash, codeScript, network, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var base_url, hash, publicKeyHash, url, response, responseData, sortedData, sumBalance, ftutxos, i, i, totalBalance, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        base_url = "";
                    ...
                    case 4:
                        ...
                        if (!(sumBalance < amount)) return [3 /*break*/, 6];
                        return [4 /*yield*/, API.getFTbalance(contractTxid, addressOrHash, network)];
                    case 5:
                        totalBalance = _a.sent();
                        if (totalBalance >= amount) {
                        ...
                        _a.label = 6;
                    case 6: return [2 /*return*/, ftutxos];
                    case 7:
                        error_6 = _a.sent();
    ...
    API.fetchFtUTXOsforPool = function (contractTxid, addressOrHash, amount, number, codeScript, network) {
        return __awaiter(this, void 0, void 0, function () {
            var base_url, hash, publicKeyHash, url, response, responseData, sortedData, sumBalance, ftutxos, i, totalBalance, error_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        sumBalance = BigInt(0);
                        ftutxos = [];
                        for (i = 0; i < sortedData.length && i < number; i++) {
                            sumBalance += BigInt(sortedData[i].ftBalance);
                            ftutxos.push({
                                txId: sortedData[i].utxoId,
                                outputIndex: sortedData[i].utxoVout,
    ...
    API.fetchFtInfo = function (contractTxid, network) {
        return __awaiter(this, void 0, void 0, function () {
            var base_url, url, response, data, ftInfo, error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        base_url = "";
    ...
    API.fetchPoolNftInfo = function (contractTxid, network) {
        return __awaiter(this, void 0, void 0, function () {
            var base_url, url, response, data, poolNftInfo, error_9;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        base_url = "";
    ...
    API.fetchPoolNftUTXO = function (contractTxid, network) {
        return __awaiter(this, void 0, void 0, function () {
            var poolNftInfo, poolnft, error_10;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    API.fetchFtlpBalance = function (ftlpCode, network) {
        return __awaiter(this, void 0, void 0, function () {
            var ftlpHash, base_url, url, response, ftlpBalance, i, error_11;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    API.fetchFtlpUTXO = function (ftlpCode, amount, network) {
        return __awaiter(this, void 0, void 0, function () {
            var ftlpHash, base_url, url, response, data, i, ftlpBalance, i, ftlp, error_12;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ftlpHash = tbc.crypto.Hash.sha256(Buffer.from(ftlpCode, "hex"))
    ...
    API.fetchTXraw = function (txid, network) {
        return __awaiter(this, void 0, void 0, function () {
            var base_url, url, response, rawtx, tx, error_13;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        base_url = "";
    ...
    API.broadcastTXraw = function (txraw, network) {
        return __awaiter(this, void 0, void 0, function () {
            var base_url, url, response, data, error_14;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        base_url = "";
    ...
    API.fetchUTXOs = function (address, network) {
        return __awaiter(this, void 0, void 0, function () {
            var base_url, url, response, data, scriptPubKey_1, error_15;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        base_url = "";
    ...
    API.getUTXOs = function (address, amount_tbc, network) {
        return __awaiter(this, void 0, void 0, function () {
            var utxos, amount_satoshis_1, closestUTXO, totalAmount, selectedUTXOs, _i, utxos_1, utxo, error_16;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
    ...
    API.fetchNFTTXO = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var script, tx_hash, network, base_url, script_hash, url, response, data, filteredUTXOs, min_vout_utxo, error_17;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    API.fetchNFTInfo = function (contract_id, network) {
        return __awaiter(this, void 0, void 0, function () {
            var base_url, url, response, data, nftInfo, error_18;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        base_url = "";
     ...
     * @throws {Error} Throws an error if the request fails.
     */
    API.fetchUMTXO = function (script_asm, network) {
        return __awaiter(this, void 0, void 0, function () {
            var multiScript, script_hash, base_url, url, response, data, selectedUTXO, i, balance, i, umtxo, error_19;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    API.fetchUMTXOs = function (script_asm, network) {
        return __awaiter(this, void 0, void 0, function () {
            var multiScript, script_hash, base_url, url, response, data, umtxos, error_20;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        multiScript = tbc.Script.fromASM(script_asm).toHex();
    ...
    API.getUMTXOs = function (script_asm, amount_tbc, network) {
        return __awaiter(this, void 0, void 0, function () {
            var umtxos, amount_satoshis_2, closestUMTXO, totalSatoshis, selectedUMTXOs, _i, umtxos_1, umtxo, error_21;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
     ...
     * @throws {Error} Throws an error if the request fails.
     */
    API.fetchFtUTXOS_multiSig = function (contractTxid, addressOrHash, codeScript, amount, network) {
        return __awaiter(this, void 0, void 0, function () {
            var base_url, hash, publicKeyHash, url, response, responseData, sortedData, ftutxos, i, ftBalanceArray, result, result_three, result_two, result_four, result_three, result_two, result_five, result_four, result_three, result_two, error_22;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        base_url = network
                    ...
                    case 3:
                        ...
                        sortedData = responseData.ftUtxoList.sort(function (a, b) { return a.ftBalance - b.ftBalance; });
                        ftutxos = [];
                            ...
                            case 4:
                                if (ftBalanceArray[0] +
                                    ...
                                    if ((0, utxoSelect_1.findMinTwoSum)([
                                        ...
                                        result_two = (0, utxoSelect_1.findMinTwoSum)([
                                            ftBalanceArray[result_three[0]],
                                            ftBalanceArray[result_three[1]],
                                            ftBalanceArray[result_three[2]],
                                        ], amount);
                            ...
                            case 5:
                                if (ftBalanceArray[0] +
                                    ...
                                    if ((0, utxoSelect_1.findMinThreeSum)([
                                        ...
                                        result_three = (0, utxoSelect_1.findMinThreeSum)([
                                            ftBalanceArray[result_four[0]],
                                            ftBalanceArray[result_four[1]],
                                            ftBalanceArray[result_four[2]],
                                            ftBalanceArray[result_four[3]],
                            ...
                            default:
                                if ((0, utxoSelect_1.findMinFiveSum)(ftBalanceArray, amount)) {
                                    ...
                                    if ((0, utxoSelect_1.findMinFourSum)([
                                        ...
                                        result_four = (0, utxoSelect_1.findMinFourSum)([
                                            ftBalanceArray[result_five[0]],
                                            ftBalanceArray[result_five[1]],
                                            ftBalanceArray[result_five[2]],
                                            ftBalanceArray[result_five[3]],
