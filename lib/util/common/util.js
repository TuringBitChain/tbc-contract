...
exports.isCoinCodeScript = exports.fillCharLengthInFT = void 0;
...
exports._isValidSHA256Hash = _isValidSHA256Hash;
exports._isValidHexString = _isValidHexString;
const tbc = __importStar(require("tbc-lib-js"));
const ftunlock_1 = require("../ft/ftunlock");
var ftscript_1 = require("../ft/ftscript");
Object.defineProperty(exports, "fillCharLengthInFT", { enumerable: true, get: function () { return ftscript_1.fillCharLengthInFT; } });
Object.defineProperty(exports, "isCoinCodeScript", { enumerable: true, get: function () { return ftscript_1.isCoinCodeScript; } });
...
function getLpCostData(poolCode) {
...
function safeJSONParse(text) {
    const replacedText = text.replace(/"(ft_value|tbc_value|lp_balance|token_balance|tbc_balance|balance|value)":\s*(\d{14,})/g, '"$1":"$2"');
...
function parseDecimalToBigInt(amount, decimal) {
...
function _isValidSHA256Hash(param) {
...
function _isValidHexString(param) {
    if (typeof param !== "string")
        return false;
    if (param.length === 0)
        return false;
