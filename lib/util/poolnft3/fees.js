...
exports.POOL3_SWAP_FEE_POLICIES = exports.POOL3_MIN_TBC_OUTPUT_SAT = void 0;
...
exports.POOL3_MIN_TBC_OUTPUT_SAT = 10n;
const policy = (lpPlan, totalFeeBps, lpFeeBps, serviceFeeAddress) => Object.freeze({
    lpPlan,
    totalFeeBps,
    lpFeeBps,
    serviceFeeAddress,
    servicePayoutThresholdSat: exports.POOL3_MIN_TBC_OUTPUT_SAT,
});
...
function validatePolicy(supplied) {
    ...
    if (supplied.lpFeeBps !== canonical.lpFeeBps ||
        ...
        supplied.servicePayoutThresholdSat !== exports.POOL3_MIN_TBC_OUTPUT_SAT) {
...
function buildPoolServiceFeeOutput(fees, recipient) {
    ...
    if (fees.serviceFeePaidSat > 0n && fees.serviceFeePaidSat < exports.POOL3_MIN_TBC_OUTPUT_SAT)
