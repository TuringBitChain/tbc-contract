...
class stableCoin extends Legacy {
    ...
    createCoin(admin, feeKey, recipient, fee, funding, message) {
        ...
        try {
            ...
            const prepared = super.createCoin(admin, feeKey, recipient, fee, funding, message);
            this.totalSupply = 0n;
            this.creating = true;
    ...
    mintCoin(admin, feeKey, recipient, humanAmount, fee, parent, grandparent, message) {
        ...
        try {
            ...
            const prepared = super.mintCoin(admin, feeKey, recipient, humanAmount, fee, parent, grandparent, message);
            this.creating = true;
