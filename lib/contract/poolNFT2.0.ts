  ...
  getFtlpCode(
    ...
    if (isCoin) {
      ...
      if (ftVersion === 2 || ftVersion === 3) {
        ...
        ftlpCodeLast = tbc.Script.fromString(
          `OP_PUSHDATA1 0x51 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff OP_DROP OP_RETURN 0x15 0x${hash} 0x05 0x02436f6465`,
        );
      }
    }
  ...
  getFtlpCodeWithLockTime(
    ...
    if (isCoin) {
      ...
      if (ftVersion === 2 || ftVersion === 3) {
        ...
        ftlpCodeLast = tbc.Script.fromString(
          `OP_PUSHDATA1 0x39 0x${"ff".repeat(0x39)} OP_DROP OP_RETURN 0x15 0x${hash} 0x05 0x02436f6465`,
        );
      }
    }
