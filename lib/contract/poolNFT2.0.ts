  ...
  getFtlpCode(
    ...
    if (isCoin) {
      ...
      ftlpCodeLast = tbc.Script.fromString(
        `OP_PUSHDATA2 0x${paddingSize.toString(16).padStart(4, "0")} 0x${"ff".repeat(paddingSize)} OP_DROP OP_RETURN 0x15 0x${hash} 0x05 0x02436f6465`,
      );
    } else {
      if (ftVersion === 2 || ftVersion === 3) {
        ...
        ftlpCodeLast = tbc.Script.fromString(
          `OP_PUSHDATA1 0x${paddingSize.toString(16).padStart(2, "0")} 0x${"ff".repeat(paddingSize)} OP_DROP OP_RETURN 0x15 0x${hash} 0x05 0x02436f6465`,
        );
      }
    }
