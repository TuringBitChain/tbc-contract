...
var NFT = /** @class */ (function () {
    ...
    NFT.prototype.initialize = function (network) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, collectionId, collectionIndex, collectionName, nftCodeBalance, nftP2pkhBalance, nftName, nftSymbol, nft_attributes, nftDescription, nftTransferTimeCount, nftIcon, file;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, API.fetchNFTInfo(this.contract_id, network)];
                    case 1:
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        tx.feePerKb(100)
                            .change(address)
                            .sign(privateKey);
                        return [4 /*yield*/, API.broadcastTXraw(tx.uncheckedSerialize(), network)];
    ...
    NFT.createNFT = function (collection_id, address, privateKey, data, utxos, network) {
        return __awaiter(this, void 0, void 0, function () {
            var hold, nfttxo, tx, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        hold = NFT.buildHoldScript(address);
                        return [4 /*yield*/, API.fetchNFTTXO({ script: hold.toBuffer().toString("hex"), tx_hash: collection_id, network: network })];
                    case 1:
                        nfttxo = _a.sent();
                        if (!data.file) {
    ...
    NFT.prototype.transferNFT = function (address_from, address_to, privateKey, utxos, network) {
        return __awaiter(this, void 0, void 0, function () {
            var code, nfttxo, pre_tx, _a, _b, pre_pre_tx, _c, _d, tx, i;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        code = NFT.buildCodeScript(this.collection_id, this.collection_index);
                        return [4 /*yield*/, API.fetchNFTTXO({ script: code.toBuffer().toString("hex"), network: network })];
                    case 1:
                        nfttxo = _e.sent();
                        _b = (_a = tbc.Transaction).bind;
                        return [4 /*yield*/, API.fetchTXraw(nfttxo.txId, network)];
                    case 2:
                        pre_tx = new (_b.apply(_a, [void 0, _e.sent()]))();
                        _d = (_c = tbc.Transaction).bind;
                        return [4 /*yield*/, API.fetchTXraw(pre_tx.toObject().inputs[0].prevTxId, network)];
                    case 3:
                        pre_pre_tx = new (_d.apply(_c, [void 0, _e.sent()]))();
                        tx = new tbc.Transaction()
                        ...
                        tx.addOutput(new tbc.Transaction.Output({
                            ...
                            .sign(privateKey)
                            .seal();
                        return [4 /*yield*/, API.broadcastTXraw(tx.uncheckedSerialize())];
