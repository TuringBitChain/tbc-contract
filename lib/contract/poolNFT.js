...
class poolNFT {
    ...
    async initPoolNFT(privateKey_from, address_to, utxo, ftPreTX, ftPrePreTxData, tbc_amount, ft_a) {
        const privateKey = privateKey_from;
        const FTA = new FT(this.ft_a_contractTxid);
        const FTAInfo = await API.fetchFtInfo(FTA.contractTxid, this.network);
        await FTA.initialize(FTAInfo);
    ...
    async increaseLP(privateKey_from, address_to, utxo, ftPreTX, ftPrePreTxData, amount_tbc) {
        const privateKey = privateKey_from;
        const FTA = new FT(this.ft_a_contractTxid);
        const FTAInfo = await API.fetchFtInfo(FTA.contractTxid, this.network);
        await FTA.initialize(FTAInfo);
    ...
    async consumeLP(privateKey_from, address_to, utxo, ftPreTX, ftPrePreTxData, contractTX, amount_lp) {
        const privateKey = privateKey_from;
        const FTA = new FT(this.ft_a_contractTxid);
        const FTAInfo = await API.fetchFtInfo(FTA.contractTxid, this.network);
        await FTA.initialize(FTAInfo);
    ...
    async swaptoToken(privateKey_from, address_to, utxo, ftPreTX, ftPrePreTxData, contractTX, amount_token) {
        const privateKey = privateKey_from;
        const FTA = new FT(this.ft_a_contractTxid);
        const FTAInfo = await API.fetchFtInfo(FTA.contractTxid, this.network);
        await FTA.initialize(FTAInfo);
    ...
    async swaptoToken_baseTBC(privateKey_from, address_to, utxo, ftPreTX, ftPrePreTxData, contractTX, amount_tbc) {
        const privateKey = privateKey_from;
        const FTA = new FT(this.ft_a_contractTxid);
        const FTAInfo = await API.fetchFtInfo(FTA.contractTxid, this.network);
        await FTA.initialize(FTAInfo);
    ...
    async swaptoTBC(privateKey_from, address_to, utxo, ftPreTX, ftPrePreTxData, contractTX, amount_tbc) {
        const privateKey = privateKey_from;
        const FTA = new FT(this.ft_a_contractTxid);
        const FTAInfo = await API.fetchFtInfo(FTA.contractTxid, this.network);
        await FTA.initialize(FTAInfo);
    ...
    async swaptoTBC_baseToken(privateKey_from, address_to, utxo, ftPreTX, ftPrePreTxData, contractTX, amount_token) {
        const privateKey = privateKey_from;
        const FTA = new FT(this.ft_a_contractTxid);
        const FTAInfo = await API.fetchFtInfo(FTA.contractTxid, this.network);
        await FTA.initialize(FTAInfo);
    ...
    async mergeFTLP(privateKey_from, utxo, ftPreTX, ftPrePreTxData) {
        const FTA = new FT(this.ft_a_contractTxid);
        const FTAInfo = await API.fetchFtInfo(FTA.contractTxid, this.network);
        await FTA.initialize(FTAInfo);
        const privateKey = privateKey_from;
    ...
    async mergeFTinPool(privateKey_from, utxo, ftPreTX, ftPrePreTxData) {
        const FTA = new FT(this.ft_a_contractTxid);
        const FTAInfo = await API.fetchFtInfo(FTA.contractTxid, this.network);
        await FTA.initialize(FTAInfo);
        const privateKey = privateKey_from;
