...
class FT {
     ...
     * @returns The unlocking script as a tbc.Script object.
     */
    getFTunlockSwap(privateKey_from, currentTX, preTX, prepreTxData, contractTX, currentUnlockIndex, preTxId, preVout) {
        const privateKey = privateKey_from;
        const prepretxdata = prepreTxData;
        ...
        //const preTX = await API.fetchTXraw(preTxId, this.network);
        const pretxdata = (0, ftunlock_1.getPreTxdata)(preTX, preVout);
