...
class FT {
    ...
    static getFTunlock(sigs, pubKey, currentTX, preTX, prepreTxData, currentUnlockIndex, preTxVout) {
        const prepretxdata = prepreTxData;
        const pretxdata = (0, ftunlock_1.getPreTxdata)(preTX, preTxVout);
        const currenttxdata = (0, ftunlock_1.getCurrentTxdata)(currentTX, currentUnlockIndex);
    ...
    static getFTunlockSwap(sigs, pubKey, currentTX, preTX, prepreTxData, contractTX, currentUnlockIndex, preTxVout, newFT) {
        const prepretxdata = prepreTxData;
        const contracttxdata = (0, ftunlock_1.getContractTxdata)(contractTX, newFT | currentTX.inputs[0].outputIndex);
        const pretxdata = (0, ftunlock_1.getPreTxdata)(preTX, preTxVout);
        const currentinputsdata = (0, ftunlock_1.getCurrentInputsdata)(currentTX);
        const currenttxdata = (0, ftunlock_1.getCurrentTxdata)(currentTX, currentUnlockIndex);
        const signature = sigs;
