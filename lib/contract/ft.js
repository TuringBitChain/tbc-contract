...
class FT {
     ...
     * @returns The unlocking script as a tbc.Script object.
     */
    getFTunlockSwap(privateKey_from, currentTX, preTX, prepreTxData, contractTX, currentUnlockIndex, preTxVout, ftVersion, isCoin) {
        const privateKey = privateKey_from;
        const prepretxdata = prepreTxData;
        const contracttxdata = (0, ftunlock_1.getContractTxdata)(contractTX, ftVersion === 2 ? -1 : currentTX.inputs[0].outputIndex);
        const pretxdata = (0, ftunlock_1.getPreTxdata)(preTX, preTxVout);
    ...
    static getFTunlockSwap(sigs, pubKey, currentTX, preTX, prepreTxData, contractTX, currentUnlockIndex, preTxVout, ftVersion, isCoin) {
        const prepretxdata = prepreTxData;
        const contracttxdata = (0, ftunlock_1.getContractTxdata)(contractTX, ftVersion === 2 ? -1 : currentTX.inputs[0].outputIndex);
        const pretxdata = (0, ftunlock_1.getPreTxdata)(preTX, preTxVout);
        const currentinputsdata = (0, ftunlock_1.getCurrentInputsdata)(currentTX);
