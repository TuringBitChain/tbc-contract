            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, api_1.API.fetchUTXO(privateKey, 0.001, this.network)];
                    case 1:
                        utxo = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, api_1.API.getFTbalance(contractTxid, addressOrHash, this.network)];
                    case 4:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 9:
                        ...
                        return [4 /*yield*/, api_1.API.broadcastTXraw(txraw, this.network)];
                    case 10:
                        _b.sent();
                        // wait 5 seconds
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        inputIndex = i / 16;
                        return [4 /*yield*/, api_1.API.fetchTXraw(preTX.inputs[inputIndex].prevTxId.toString('hex'), this.network)];
                    case 3:
                        prepreTX = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        privateKey = privateKey_from;
                        return [4 /*yield*/, api_1.API.fetchTXraw(currentTX.inputs[0].prevTxId.toString('hex'), this.network)];
                    case 1:
                        contractTX = _a.sent();
