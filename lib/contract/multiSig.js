...
class MultiSig {
     ...
     * @returns The raw serialized transaction string
     */
    static buildMultiSigTransaction_sendTBCToP2pkh(address_from, address_to, amount_tbc, utxos) {
     ...
     * @returns The raw serialized transaction string
     */
    static buildMultiSigTransaction_sendTBCToMultiSig(address_from, address_to, amount_tbc, utxos) {
        const script_asm_from = MultiSig.getMultiSigLockScript(address_from);
