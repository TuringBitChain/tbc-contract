...
class MultiSig {
  ...
  */
    static createMultiSigTransaction(address_from, pubKeys, signatureCount, publicKeyCount, amount_tbc, utxos, privateKey) {
     ...
     * @returns The raw serialized transaction string
     */
    static p2pkhToMultiSig_sendTBC(fromAddress, toAddress, amount_tbc, utxos, privateKey) {
     ...
     * @returns The raw serialized transaction string
     */
    static buildMultiSigTransaction_sendTBC(fromAddress, toAddress, amount_tbc, utxos) {
     ...
     */
    static signMultiSigTransaction_sendTBC(fromAddress, multiSigTxraw, privateKey) {
     ...
     * @returns The raw serialized transaction string
     */
    static p2pkhToMultiSig_transferFT(address_from, address_to, ft, ft_amount, utxo, ftutxos, preTX, prepreTxData, privateKey) {
     ...
     * @returns The raw serialized transaction string
     */
    static buildMultiSigTransaction_transferFT(address_from, address_to, ft, ft_amount, utxo, ftutxos, preTX, prepreTxData, privateKey) {
        const code = ft.codeScript;
        const tape = ft.tapeScript;
        const decimal = ft.decimal;
        const tapeAmountSetIn = [];
