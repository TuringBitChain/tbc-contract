...
class OrderBook {
    ...
    buildSellOrderTX(holdAddress, saleVolume, unitPrice, feeRate, ftID, ftPartialHash, utxos) {
        ...
        if (!(0, util_1._isValidSHA256Hash)(ftID) || !(0, util_1._isValidSHA256Hash)(ftPartialHash))
            throw new Error("FTID and FTPartialHash must be valid SHA256 hash strings");
        this.type = "sell";
    ...
    async makeBuyOrder_privateKeyOnline(privateKey, saleVolume, unitPrice, feeRate, ftID) {
        ...
        const ftutxo_codeScript = FT.buildFTtransferCode(TokenInfo.codeScript, privateKey.toAddress().toString())
            .toBuffer()
            .toString("hex");
