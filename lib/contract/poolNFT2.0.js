...
class poolNFT2 {
    ...
    getFtlpCodeWithLockTime(poolNftCodeHash, address, tapeSize, isCoin, ftVersion) {
        ...
        let ftlpCodeLast;
        if (isCoin) {
            ftlpCodeLast = tbc.Script.fromString(`OP_PUSHDATA2 0x0229  OP_DROP OP_RETURN 0x15 0x${hash} 0x05 0x02436f6465`);
        }
        else {
            if (ftVersion === 2) {
