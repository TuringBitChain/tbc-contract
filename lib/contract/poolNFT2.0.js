...
class poolNFT2 {
     ...
     * @param {tbc.Transaction.IUnspentOutput} utxo - The unspent output used to create the transaction.
     * @param {number | string} tbc_amount - The initial TBC amount.
    ...
    async initPoolNFT(privateKey_from, address_to, utxo, tbc_amount, ft_a, lock_time) {
        ...
        if (Number(tbc_amount) > 0 && Number(ft_a) > 0) {
            amount_lpbn = (0, util_1.parseDecimalToBigInt)(tbc_amount, 6);
            this.tbc_amount = (0, util_1.parseDecimalToBigInt)(tbc_amount, 6);
            this.ft_lp_amount = this.tbc_amount;
            this.ft_a_number = Number(ft_a);
            this.ft_a_amount = (0, util_1.parseDecimalToBigInt)(ft_a, FTA.decimal);
        }
        else {
     ...
     * @param {string} address_to - The FT-LP receiving address.
     * @param {tbc.Transaction.IUnspentOutput} utxo - The unspent output used to create the transaction.
     * @param {number} tbc_amount - The TBC amount.
    ...
    async initPoolNFTWithLockTime(privateKey_from, address_to, utxo, tbc_amount, ft_a, lock_time) {
        ...
        if (tbc_amount > 0 && ft_a > 0) {
            ...
            this.ft_a_amount = BigInt(Math.round(this.ft_a_number * Math.pow(10, FTA.decimal)));
        }
        else {
            throw new Error("Invalid amount Input");
        }
